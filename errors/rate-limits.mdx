---
title: "Piramyd API Rate Limits, Tiers, and Request Quotas"
sidebarTitle: "Rate Limits"
description: "Piramyd enforces per-key RPM limits, not token limits. Compare tier allowances, learn to buy extra RPM, and handle 429 responses correctly."
---
