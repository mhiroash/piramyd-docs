---
title: "Piramyd API Error Codes and Response Shapes"
sidebarTitle: "Error Reference"
description: "Reference for every Piramyd HTTP status code and error response format, including non-streaming and streaming error shapes."
---
