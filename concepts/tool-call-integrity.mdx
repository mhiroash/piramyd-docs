...
description: "Piramyd buffers, validates, and auto-repairs streaming tool call arguments. Your agent always receives complete, valid JSON — no client changes needed."
---
