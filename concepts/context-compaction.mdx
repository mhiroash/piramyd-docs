...
description: "Piramyd automatically compacts long conversation histories when they approach a model's context window, so multi-turn sessions run without interruption."
---
