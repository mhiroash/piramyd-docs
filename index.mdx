---
title: "Piramyd: OpenAI-Compatible Inference Gateway for AI"
sidebarTitle: "Home"
description: "Route AI requests to OpenAI, Anthropic, and more through one OpenAI-compatible API. Built-in web search, scraping, and crawling included."
---
