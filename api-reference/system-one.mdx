---
title: "POST /v1/systemone — System One Decision API"
sidebarTitle: "System One"
description: "POST /v1/systemone — typed decision endpoint for Jev models. Accepts a state and typed questions, returns calibrated probabilities and choices in 70–500 ms."
---
...
| `404` | `model_not_found` | Model ID not found | Use `GET /v1/systemone/models` |
