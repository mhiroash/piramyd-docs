---
title: "Extract Structured Data with LLMs — POST /v1/extract"
sidebarTitle: "Extract"
description: "POST /v1/extract — use an LLM to pull structured data from up to 20 URLs. Describe what to extract in plain English; enforce shape with JSON Schema."
---
