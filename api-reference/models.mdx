---
title: "GET /v1/models — List and Retrieve Models"
sidebarTitle: "Models"
description: "GET /v1/models returns all available models with capabilities, context windows, and supported endpoints. Always discover models at runtime — never hardcode model IDs."
---
