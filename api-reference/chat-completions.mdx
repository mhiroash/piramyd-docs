---
title: "Piramyd Chat Completions — POST /v1/chat/completions"
sidebarTitle: "Chat Completions"
description: "Primary OpenAI-compatible inference endpoint. Supports streaming, tool calling, vision, thread-based context compaction, and all standard parameters."
---
