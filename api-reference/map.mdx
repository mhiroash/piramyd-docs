---
title: "Discover All Website URLs — POST /v1/map via CROWD"
sidebarTitle: "Map"
description: "POST /v1/map — discover all URLs on a site without fetching content. Understand site structure before targeting pages to scrape or crawl."
---
